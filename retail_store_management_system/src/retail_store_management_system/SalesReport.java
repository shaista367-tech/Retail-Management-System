...
public class SalesReport extends javax.swing.JFrame {
    ...
    public void report() {
        ...
        String[] tblHead = {"ID", "Customer Name", "Mobile", "Date", "Total"};
        ...
        try {
            ...
            while (ps.rs.next()) {
                String[] item = {
                    ps.rs.getString("order_id"),
                    ps.rs.getString("order_name"),
                    ps.rs.getString("order_mobile"),
                    ps.rs.getString("order_date"),
                    ps.rs.getString("order_total")
                };
                header.addRow(item);
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Sales Report"));
